#ifndef TRIAL_URL_SYNTAX_REGNAME_IPP
#define TRIAL_URL_SYNTAX_REGNAME_IPP
...
std::size_t regname<CharT>::match(const view_type& view)
{
...
#endif // TRIAL_URL_SYNTAX_REGNAME_IPP
