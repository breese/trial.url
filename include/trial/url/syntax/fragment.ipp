#ifndef TRIAL_URL_SYNTAX_FRAGMENT_IPP
#define TRIAL_URL_SYNTAX_FRAGMENT_IPP
...
std::size_t fragment<CharT>::match(const view_type& view)
{
...
#endif // TRIAL_URL_SYNTAX_FRAGMENT_IPP
